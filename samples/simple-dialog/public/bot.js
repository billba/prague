...
var prague_1 = __webpack_require__(34);
var prague_botframework_1 = __webpack_require__(43);
__export(__webpack_require__(34));
__export(__webpack_require__(43));
var BrowserBot = (function () {
    function BrowserBot(chat, data) {
        this.chat = chat;
        this.data = data;
    }
    BrowserBot.prototype.run = function (routers) {
        var _this = this;
        var router = prague_1.prependMatcher(function (message) { return (__assign({}, message, { data: _this.data })); }, prague_botframework_1.chatRouter(this.chat, routers));
        this.chat.activity$
            .map(function (activity) { return ({ activity: activity }); })
            .do(function (message) { return prague_1.konsole.log("activity", message.activity); })
            .flatMap(function (message) { return prague_1.routeMessage(router, message); }, 1)
            .subscribe(function (message) { return prague_1.konsole.log("handled", message); }, function (error) { return prague_1.konsole.log("error", error); }, function () { return prague_1.konsole.log("complete"); });
    };
    return BrowserBot;
}());
...
var isDebug = function () {
    return (typeof (window) !== 'undefined' && window["pragueDebug"]) ||
...
Object.defineProperty(exports, "__esModule", { value: true });
var Konsole_1 = __webpack_require__(16);
...
function ifMatch() {
    ...
    var router = exports.routerize(args[args.length - 1]);
    switch (args.length) {
        case 1:
            return router;
        case 2:
            return exports.prependMatcher(args[0], router);
        default:
            return exports.prependMatcher(combineMatchers.apply(void 0, args.slice(0, args.length - 1)), router);
    }
}
...
var BehaviorSubject_1 = __webpack_require__(35);
...
var AjaxObservable_1 = __webpack_require__(67);
...
var rxjs_1 = __webpack_require__(19);
var prague_1 = __webpack_require__(34);
var botframework_directlinejs_1 = __webpack_require__(95);
var UniversalChat = (function () {
    ...
    UniversalChat.prototype.sendAsync = function (to, what) {
        var activity = typeof what === "string"
            ? {
                type: 'message',
                from: { id: 'from' },
                text: what,
            ...
            } : __assign({}, what, { channelId: to.channelId, conversation: { id: to.conversationId } });
        return this.postActivity(activity);
    };
    UniversalChat.prototype.send = function (to, what) {
...
exports.reply = function (toSend) { return function (message) { return message.reply(toSend); }; };
exports.matchActivity = function (chat) { return function (message) {
    var address = exports.getAddress(message.activity);
    return __assign({}, message, { // remove "as any" when TypeScript fixes this bug
        // IChatActivityMatch
        address: address, reply: function (activity) { return chat.send(address, activity); }, replyAsync: function (activity) { return chat.sendAsync(address, activity); } });
}; };
exports.matchMessage = function (message) {
    return message.activity.type === 'message' && __assign({}, message, { 
        // IChatMessageMatch
        text: message.activity.text, message: message.activity });
};
exports.matchEvent = function (message) {
    return message.activity.type === 'event' && __assign({}, message, { 
        // IChatEventMatch
        event: message.activity });
};
exports.matchTyping = function (message) {
    return message.activity.type === 'typing' && __assign({}, message, { 
        // IChatTypingMatch
        typing: message.activity });
};
exports.chatRouter = function (chat, rules) {
    return prague_1.prependMatcher(exports.matchActivity(chat), prague_1.first(rules.message && prague_1.prependMatcher(exports.matchMessage, rules.message), rules.event && prague_1.prependMatcher(exports.matchEvent, rules.event), rules.typing && prague_1.prependMatcher(exports.matchTyping, rules.typing), rules.activity));
};
exports.createChoice = function (text, choices) { return ({
    type: 'message',
    from: { id: 'MyBot' },
    text: text,
...
exports.createConfirm = function (text) {
    var choices = ['Yes', 'No'];
    return exports.createChoice(text, choices);
};
var WebChatConnector = (function () {
    ...
    WebChatConnector.prototype.postActivityToChat = function (activity) {
        prague_1.konsole.log("posting", activity);
...
var Observable_1 = __webpack_require__(0);
var ajax_1 = __webpack_require__(238);
...
var Observable_1 = __webpack_require__(0);
var empty_1 = __webpack_require__(240);
...
var Observable_1 = __webpack_require__(0);
var of_1 = __webpack_require__(250);
...
var Observable_1 = __webpack_require__(0);
var throw_1 = __webpack_require__(253);
...
var Observable_1 = __webpack_require__(0);
var catch_1 = __webpack_require__(264);
...
var Observable_1 = __webpack_require__(0);
var count_1 = __webpack_require__(269);
...
var Observable_1 = __webpack_require__(0);
var retryWhen_1 = __webpack_require__(307);
...
var ArrayObservable_1 = __webpack_require__(11);
var ArrayLikeObservable_1 = __webpack_require__(214);
var iterator_1 = __webpack_require__(22);
var Observable_1 = __webpack_require__(0);
var observeOn_1 = __webpack_require__(40);
var observable_1 = __webpack_require__(27);
...
var AsapAction_1 = __webpack_require__(343);
var AsapScheduler_1 = __webpack_require__(344);
/**
 *
 * Asap Scheduler
 *
...
var QueueAction_1 = __webpack_require__(345);
var QueueScheduler_1 = __webpack_require__(346);
/**
 *
 * Queue Scheduler
 *
...
Object.defineProperty(exports, "__esModule", { value: true });
var rootDialogInstance;
var prague_botframework_browserbot_1 = __webpack_require__(10);
var webChat = new prague_botframework_browserbot_1.WebChatConnector();
window["browserBot"] = webChat.botConnection;
var browserBot = new prague_botframework_browserbot_1.BrowserBot(new prague_botframework_browserbot_1.UniversalChat(webChat.chatConnector), undefined);
// General purpose rule stuff
var prague_botframework_browserbot_2 = __webpack_require__(10);
// Regular Expressions
var prague_botframework_browserbot_3 = __webpack_require__(10);
// LUIS
var prague_botframework_browserbot_4 = __webpack_require__(10);
// WARNING: don't check your LUIS id/key in to your repo!
var luis = new prague_botframework_browserbot_4.LuisModel('id', 'key');
// Dialogs
var prague_botframework_browserbot_5 = __webpack_require__(10);
var dialogs = new prague_botframework_browserbot_5.Dialogs({
    get: function (match) { return rootDialogInstance; },
    set: function (match, rdi) {
...
var gameDialog = dialogs.add('game', function (dialog, m, args) {
    if (args === void 0) { args = { upperLimit: 50, numGuesses: 10 }; }
...
}, function (dialog) { return prague_botframework_browserbot_2.first(prague_botframework_browserbot_3.ifMatchRE(/\d+/, function (m) {
    var guess = parseInt(m.groups[0]);
...
}), function (m) { return m.reply("Please guess a number between 1 and 50."); }); });
var rootDialog = dialogs.add('root', function (dialog) { return prague_botframework_browserbot_2.first(prague_botframework_browserbot_3.ifMatchRE(/start game/, function (m) { return dialog.activate('game'); }), dialog.routeTo('game'), function (m) { return m.reply("Type 'start game' to start the game"); }); });
var appRule = dialogs.routeToRoot('root');
// first(
//     m => m.reply("hey")
// )
browserBot.run({
...
exports.nameize = function (dialogOrName) {
...
var dialogInstances = {};
exports.inMemoryDialogInstances = {
    createInstance: function (name, dialogData) {
        if (dialogData === void 0) { dialogData = {}; }
    ...
    destroyInstance: function (dialogInstance) {
        dialogInstances[dialogInstance.name][dialogInstance.instanceId] = undefined;
    },
    getDialogState: function (dialogInstance) { return (__assign({}, dialogInstances[dialogInstance.name][dialogInstance.instanceId])); },
    setDialogState: function (dialogInstance, dialogData) {
        dialogInstances[dialogInstance.name][dialogInstance.instanceId] = dialogData;
    }
};
var Dialogs = (function () {
    function Dialogs(rootDialogInstance, localDialogInstances) {
        if (localDialogInstances === void 0) { localDialogInstances = exports.inMemoryDialogInstances; }
        this.rootDialogInstance = rootDialogInstance;
        this.localDialogInstances = localDialogInstances;
        this.dialogRegistry = {};
    }
    Dialogs.prototype.localOrRemoteDialog = function (dialogOrName) {
        if (typeof dialogOrName !== 'string')
            return dialogOrName;
        var localOrRemoteDialog = this.dialogRegistry[dialogOrName];
    ...
    Dialogs.prototype.getRouteFromDialogInstance = function (dialogInstance, m, dialogResponseHandler, end) {
        var _this = this;
        ...
        if (!dialogInstance)
            return;
        var localOrRemoteDialog = this.dialogRegistry[dialogInstance.name];
        if (!localOrRemoteDialog) {
            Konsole_1.konsole.warn("An attempt was made to route to a dialog named \"" + dialogInstance.name + "\", which doesn't exist.");
            return;
        }
        if (isLocalDialog(localOrRemoteDialog)) {
            Konsole_1.konsole.log("getRouteFromDialogInstance local", m);
            return Rules_1.toObservable(this.localDialogInstances.getDialogState(dialogInstance))
                .flatMap(function (dialogState) {
                return localOrRemoteDialog.router(_this.createDialogRouterHelper(dialogInstance, m, dialogState, dialogResponseHandler, end))
                    .getRoute(m)
                    .map(function (route) { return (__assign({}, route, { action: function () {
                        return Rules_1.toObservable(route.action())
                            .flatMap(function (_) { return Rules_1.toObservable(_this.localDialogInstances.setDialogState(dialogInstance, dialogState)); });
                    } })); });
            });
        }
        // else {
    ...
    //     }
    // }
    Dialogs.prototype.createDialogInstance = function (dialogOrName, m, dialogArgs, dialogResponseHandler) {
        var _this = this;
        ...
        if (isLocalDialog(localOrRemoteDialog)) {
            if (!localOrRemoteDialog.constructor)
                return Rules_1.toObservable(this.localDialogInstances.createInstance(localOrRemoteDialog.localName));
            var ended_1 = false;
            var shim = function (dialogResponse) {
                ended_1 = true;
                return dialogResponseHandler(dialogResponse);
            };
            var dialogConstructorHelper_1 = this.createDialogConstructorHelper(m, shim);
            return Rules_1.toObservable(localOrRemoteDialog.constructor(dialogConstructorHelper_1, m, dialogArgs))
                .flatMap(function (_) {
                if (ended_1)
    ...
    //         } as RemoteTryMatchResponse));
    // }
    Dialogs.prototype.createRoot = function (dialogOrName, m, args) {
        var _this = this;
        return Rules_1.toObservable(this.createDialogInstance(dialogOrName, m, args))
            .flatMap(function (dialogInstance) {
            return Rules_1.toObservable(_this.rootDialogInstance.set(m, dialogInstance))
                .map(function (_) { return dialogInstance; });
        })
            .toPromise();
    };
    Dialogs.prototype.routeToRoot = function (dialogOrName, args) {
        var _this = this;
        return {
            getRoute: function (m) {
                return Rules_1.toObservable(_this.rootDialogInstance.get(m))
                    .flatMap(function (dialogInstance) {
                    if (!dialogInstance) {
                        if (!dialogOrName) {
    ...
    Dialogs.prototype.createDialogConstructorHelper = function (m, dialogResponseHandler) {
        return {
            state: {},
    ...
    Dialogs.prototype.createDialogRouterHelper = function (dialogInstance, m, dialogState, dialogResponseHandler, end) {
        var _this = this;
        return {
            // core
            state: dialogState.state,
            createInstance: function (dialogOrName, dialogArgs, dialogResponseHandler) {
            ...
            replace: function (dialogOrName, args) {
                return end()
                    ? _this.createDialogInstance(args[0], args[1])
            ...
            setChild: function () {
                ...
                return _this.createDialogInstance.apply(_this, [args[0], m, args[1]].concat(args.slice(2))).map(function (dialogInstance) {
                    dialogState.child = dialogInstance;
                })
                    .toPromise();
            },
            ...
            activate: function (dialogOrName, dialogArgs, dialogResponseHandler) {
                console.log("dialog.activate", dialogOrName, dialogInstance, dialogState);
                return _this.createDialogInstance(dialogOrName, m, dialogArgs, dialogResponseHandler)
                    .map(function (dialogInstance) {
            ...
            deactivate: function (dialogOrName) {
                if (dialogState.activeDialogs)
                    dialogState.activeDialogs[exports.nameize(dialogOrName)] = undefined;
            },
            ...
            routeTo: function (dialogOrName, dialogResponseHandler) {
                console.log("dialog.routeTo", dialogOrName, dialogInstance, dialogState, dialogInstances);
...
var LuisModel = (function () {
    ...
    LuisModel.prototype.call = function (utterance) {
        ...
        if (this.url === 'testData') {
            var luisResponse = this.testData[utterance];
            if (!luisResponse)
                return rxjs_1.Observable.empty();
...
exports.promptChoice = function (choices, ruleOrHandler) {
    return Rules_1.ifMatch(exports.matchChoice(choices), ruleOrHandler);
};
...
exports.promptConfirm = function (ruleOrHandler) {
    return Rules_1.ifMatch(exports.matchConfirm(), ruleOrHandler);
};
...
var Konsole_1 = __webpack_require__(16);
var Rules_1 = __webpack_require__(17);
exports.matchRE = function (intents) {
    return function (message) {
...
exports.ifMatchRE = function (intents, ruleOrHandler) {
    return Rules_1.ifMatch(exports.matchRE(intents), ruleOrHandler);
};
...
var Observable_1 = __webpack_require__(0);
var bindCallback_1 = __webpack_require__(232);
...
var Observable_1 = __webpack_require__(0);
var bindNodeCallback_1 = __webpack_require__(233);
...
var Observable_1 = __webpack_require__(0);
var combineLatest_1 = __webpack_require__(234);
...
var Observable_1 = __webpack_require__(0);
var concat_1 = __webpack_require__(235);
...
var Observable_1 = __webpack_require__(0);
var defer_1 = __webpack_require__(236);
...
var Observable_1 = __webpack_require__(0);
var webSocket_1 = __webpack_require__(239);
...
var Observable_1 = __webpack_require__(0);
var forkJoin_1 = __webpack_require__(241);
...
var Observable_1 = __webpack_require__(0);
var fromEvent_1 = __webpack_require__(243);
...
var Observable_1 = __webpack_require__(0);
var fromEventPattern_1 = __webpack_require__(244);
...
var Observable_1 = __webpack_require__(0);
var fromPromise_1 = __webpack_require__(245);
...
var Observable_1 = __webpack_require__(0);
var GenerateObservable_1 = __webpack_require__(222);
...
var Observable_1 = __webpack_require__(0);
var if_1 = __webpack_require__(246);
...
var Observable_1 = __webpack_require__(0);
var never_1 = __webpack_require__(249);
...
var Observable_1 = __webpack_require__(0);
var onErrorResumeNext_1 = __webpack_require__(74);
...
var Observable_1 = __webpack_require__(0);
var pairs_1 = __webpack_require__(251);
...
var Observable_1 = __webpack_require__(0);
var race_1 = __webpack_require__(75);
...
var Observable_1 = __webpack_require__(0);
var range_1 = __webpack_require__(252);
...
var Observable_1 = __webpack_require__(0);
var using_1 = __webpack_require__(255);
...
var Observable_1 = __webpack_require__(0);
var audit_1 = __webpack_require__(257);
...
var Observable_1 = __webpack_require__(0);
var auditTime_1 = __webpack_require__(258);
...
var Observable_1 = __webpack_require__(0);
var buffer_1 = __webpack_require__(259);
...
var Observable_1 = __webpack_require__(0);
var bufferTime_1 = __webpack_require__(261);
...
var Observable_1 = __webpack_require__(0);
var bufferToggle_1 = __webpack_require__(262);
...
var Observable_1 = __webpack_require__(0);
var bufferWhen_1 = __webpack_require__(263);
...
var Observable_1 = __webpack_require__(0);
var combineAll_1 = __webpack_require__(265);
...
var Observable_1 = __webpack_require__(0);
var concatMap_1 = __webpack_require__(267);
...
var Observable_1 = __webpack_require__(0);
var concatMapTo_1 = __webpack_require__(268);
...
var Observable_1 = __webpack_require__(0);
var debounce_1 = __webpack_require__(270);
...
var Observable_1 = __webpack_require__(0);
var debounceTime_1 = __webpack_require__(271);
...
var Observable_1 = __webpack_require__(0);
var defaultIfEmpty_1 = __webpack_require__(272);
...
var Observable_1 = __webpack_require__(0);
var delayWhen_1 = __webpack_require__(274);
...
var Observable_1 = __webpack_require__(0);
var dematerialize_1 = __webpack_require__(275);
...
var Observable_1 = __webpack_require__(0);
var distinct_1 = __webpack_require__(276);
...
var Observable_1 = __webpack_require__(0);
var distinctUntilChanged_1 = __webpack_require__(68);
...
var Observable_1 = __webpack_require__(0);
var distinctUntilKeyChanged_1 = __webpack_require__(277);
...
var Observable_1 = __webpack_require__(0);
var every_1 = __webpack_require__(280);
...
var Observable_1 = __webpack_require__(0);
var exhaust_1 = __webpack_require__(281);
...
var Observable_1 = __webpack_require__(0);
var expand_1 = __webpack_require__(283);
...
var Observable_1 = __webpack_require__(0);
var finally_1 = __webpack_require__(284);
...
var Observable_1 = __webpack_require__(0);
var findIndex_1 = __webpack_require__(285);
...
var Observable_1 = __webpack_require__(0);
var first_1 = __webpack_require__(286);
...
var Observable_1 = __webpack_require__(0);
var groupBy_1 = __webpack_require__(287);
...
var Observable_1 = __webpack_require__(0);
var ignoreElements_1 = __webpack_require__(288);
...
var Observable_1 = __webpack_require__(0);
var last_1 = __webpack_require__(290);
...
var Observable_1 = __webpack_require__(0);
var let_1 = __webpack_require__(291);
...
var Observable_1 = __webpack_require__(0);
var mergeMapTo_1 = __webpack_require__(73);
...
var Observable_1 = __webpack_require__(0);
var mergeScan_1 = __webpack_require__(295);
...
var Observable_1 = __webpack_require__(0);
var min_1 = __webpack_require__(296);
...
var Observable_1 = __webpack_require__(0);
var pairwise_1 = __webpack_require__(297);
...
var Observable_1 = __webpack_require__(0);
var partition_1 = __webpack_require__(298);
...
var Observable_1 = __webpack_require__(0);
var pluck_1 = __webpack_require__(299);
...
var Observable_1 = __webpack_require__(0);
var publish_1 = __webpack_require__(300);
...
var Observable_1 = __webpack_require__(0);
var publishBehavior_1 = __webpack_require__(301);
...
var Observable_1 = __webpack_require__(0);
var publishLast_1 = __webpack_require__(302);
...
var Observable_1 = __webpack_require__(0);
var publishReplay_1 = __webpack_require__(303);
...
var Observable_1 = __webpack_require__(0);
var repeatWhen_1 = __webpack_require__(305);
...
var Observable_1 = __webpack_require__(0);
var retry_1 = __webpack_require__(306);
...
var Observable_1 = __webpack_require__(0);
var sample_1 = __webpack_require__(308);
...
var Observable_1 = __webpack_require__(0);
var sampleTime_1 = __webpack_require__(309);
...
var Observable_1 = __webpack_require__(0);
var throttle_1 = __webpack_require__(76);
...
var Observable_1 = __webpack_require__(0);
var windowTime_1 = __webpack_require__(335);
...
var Observable_1 = __webpack_require__(0);
var withLatestFrom_1 = __webpack_require__(338);
...
var Observable_1 = __webpack_require__(0);
var zipAll_1 = __webpack_require__(339);
...
var BoundCallbackObservable_1 = __webpack_require__(215);
...
var BoundNodeCallbackObservable_1 = __webpack_require__(216);
...
var DeferObservable_1 = __webpack_require__(217);
...
var tryCatch_1 = __webpack_require__(8);
var errorObject_1 = __webpack_require__(6);
var assign_1 = __webpack_require__(357);
/**
 * We need this JSDoc comment for affecting ESDoc.
 * @extends {Ignored}
 * @hide true
...
var WebSocketSubject_1 = __webpack_require__(237);
...
var FromEventPatternObservable_1 = __webpack_require__(221);
...
var IfObservable_1 = __webpack_require__(223);
...
var IntervalObservable_1 = __webpack_require__(224);
...
var NeverObservable_1 = __webpack_require__(226);
...
var PairsObservable_1 = __webpack_require__(227);
...
var RangeObservable_1 = __webpack_require__(228);
...
var ErrorObservable_1 = __webpack_require__(218);
...
var TimerObservable_1 = __webpack_require__(230);
...
var UsingObservable_1 = __webpack_require__(231);
...
var OuterSubscriber_1 = __webpack_require__(2);
var subscribeToResult_1 = __webpack_require__(3);
var Set_1 = __webpack_require__(356);
/**
...
var FastMap_1 = __webpack_require__(352);
/* tslint:enable:max-line-length */
/**
...
var not_1 = __webpack_require__(358);
var filter_1 = __webpack_require__(69);
/**
...
var Immediate_1 = __webpack_require__(353);
var AsyncAction_1 = __webpack_require__(20);
/**
 * We need this JSDoc comment for affecting ESDoc.
 * @ignore
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(91).clearImmediate, __webpack_require__(91).setImmediate))
...
var root_1 = __webpack_require__(7);
var MapPolyfill_1 = __webpack_require__(355);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(92), __webpack_require__(44)))
